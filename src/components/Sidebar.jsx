...
const Sidebar = ({sideBarFn,
  ...
  return (
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item" onClick={() => sideBarFn("home")}>
        <a href="#" class={`nav-link text-white ${sideBarTagActive === "home" && 'active'}`} aria-current="page">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlinkHref="#home"></use></svg>
          Home
        </a>
      </li>
      <li onClick={() => sideBarFn("dashboard")}>
        <a href="#" class={`nav-link text-white ${sideBarTagActive === "dashboard" && 'active'}`}>
