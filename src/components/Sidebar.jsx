  ...
  return (
    ...
    <ul className="nav nav-pills flex-column mb-auto">
      <li className="nav-item" onClick={() => sideBarFn("home")}>
        <a href="#" className={`nav-link text-white ${sideBarTagActive === "home" && 'active'}`} aria-current="page">
          <svg className="bi pe-none me-2" width="16" height="16"><use xlinkHref="#home"></use></svg>
          Home
        </a>
      </li>
      <li onClick={() => sideBarFn("dashboard")}>
        <a href="#" className={`nav-link text-white ${sideBarTagActive === "dashboard" && 'active'}`}>
